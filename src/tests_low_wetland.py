from spread_models import low_wetland
...
output_dict =low_wetland.calculate(df.to_xarray(),fuel_params_df.iloc[0])
...
print(df.head())
print(df.shape)
df.to_csv('tests/low_wetland_small.csv', index=False)
# df.to_pickle('tests/low_wetland_small.pkl')