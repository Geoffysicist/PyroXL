from spread_models import rural
...
output_dict =rural.calculate(df.to_xarray(),fuel_params_df.iloc[0])
...
print(df.head())
print(df.shape)
df.to_csv('tests/rural_small.csv', index=False)
# df.to_pickle('tests/rural_small.pkl')
