"""Fire behaviour calculations for wetlands are using the chenopod-script for now. Date: 2017/10/12.
"""

"""Fire behaviour calculations for (eaten out) grasslands
"""
import numpy as np
...
def calc_rate_of_spread(dead_fuel_moisture, wind_speed, curing):
