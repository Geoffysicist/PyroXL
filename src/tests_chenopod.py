from spread_models import chenopod
...
output_dict =chenopod.calculate(df.to_xarray(),fuel_params_df.iloc[0])
...
print(df.head())
print(df.shape)
df.to_csv('tests/chenopod_small.csv', index=False)
# df.to_pickle('tests/chenopod_small.pkl')