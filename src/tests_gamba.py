from spread_models import gamba
...
output_dict =gamba.calculate(df.to_xarray(),fuel_params_df.iloc[0])
...
print(df.head())
print(df.shape)
df.to_csv('tests/gamba_small.csv', index=False)
# df.to_pickle('tests/gamba_small.pkl')
