from spread_models import spinifex
...
output_dict =spinifex.calculate(df.to_xarray(),fuel_params_df.iloc[0])
...
print(df.head())
print(df.shape)
df.to_csv('tests/spinifex_small.csv', index=False)
# df.to_pickle('tests/spinifex_small.pkl')